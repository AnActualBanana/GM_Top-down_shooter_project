if Normal_zombie_spawn_timer = Normal_zombie_spawn_time_round && Normal_zombie_spawned_round < Normal_zombie_spawn_count_round {
	var next_spawn_x = choose ((Obj_player.x - random_range(75, 400)), Obj_player.x + random_range(75, 400))
	var next_spawn_y = choose ((Obj_player.y - random_range(75, 400)), Obj_player.y + random_range(75, 400))
