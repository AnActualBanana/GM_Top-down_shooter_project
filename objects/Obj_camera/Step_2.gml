...
var _x = clamp(Obj_player.Player_ids.Player_1.x-View_width/2, 0, room_width-View_width);
var _y = clamp(Obj_player.Player_ids.Player_1.y-View_height/2, 0, room_height-View_height);
